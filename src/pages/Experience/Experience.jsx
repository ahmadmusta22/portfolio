...
const ExperienceSection = () => {
  const experiences = [
    ...
    },
    {
      ...
      description:
        "Comprehensive front-end development course. Developed FreshCart (Full e-commerce app), Recipes finder (Recipe app), and Notes manager (Note-taking app) using modern web technologies.",
    },
    {
      icon: Code2,
