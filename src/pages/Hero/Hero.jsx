...
export default function Hero() {
  const words = [
    ...
    "Modern Web Apps & UI/UX Passionate",
...
const profile = {
    ...
    skills: [
        ...
        'Storybook', 'Node.js', 'NestJS', 'Jest',
        'Bootstrap', 'jQuery', 'Font Awesome', 'Git'
    ],
    passionate: true,
    quickLearner: true,
    problemSolver: true,
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  React.js specialist 🚀 | Modern web apps enthusiast 💻 | 
                  Passionate about crafting interactive experiences ✨
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                {/* Contact Button */}
                <a
                  href="/Ahmad_Mustafa_CV.pdf"
                  download="Ahmad_Mustafa_CV.pdf"
